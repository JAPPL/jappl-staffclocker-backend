...
from jappl_time_log.views.timelog.timelog_mark_as_paid_view import TimeLogMarkAsPaidView
...
timelog_url = [
    ...
    path("mark_as_paid/<int:pk>", TimeLogMarkAsPaidView.as_view(), name="timelog_mark_as_paid"),
]
